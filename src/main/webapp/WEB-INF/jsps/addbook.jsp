...
<div class="container">
    ...
    <div class="form-field col-lg-6">
        ...
        <div class="form-field col-lg-6">
            <form:label path="is_book_available">Enter Book Department:</form:label>
            <form:input path="book_dept" type="text" required="required" cssClass="input-text js-input"/>

        </div>

        <div class="form-field col-lg-6">
        <form:label path="is_book_available">Is Book Available:</form:label>
            <form:input path="is_book_available" type="text" required="required" cssClass="input-text js-input"/>
        </div>
